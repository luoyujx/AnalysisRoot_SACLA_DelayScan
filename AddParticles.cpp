...
void AddXenon(MyParticleContainer &particles)
{
	...
	particles.Add("Xe14P", 13, MyMass::Xenon(), 0);
	particles.Add("Xe15P", 13, MyMass::Xenon(), 0);
	particles.Add("Xe16P", 13, MyMass::Xenon(), 0);
	particles.Add("Xe17P", 13, MyMass::Xenon(), 0);
	particles.Add("Xe18P", 13, MyMass::Xenon(), 0);
	particles.Add("Xe19P", 13, MyMass::Xenon(), 0);
	particles.Add("Xe20P", 13, MyMass::Xenon(), 0);
}
...
void AddCH2I2_II(MyParticleContainer &particles)
{
	...
	particles.Add("C4p", 4, MyMass::Carbon12(), 0, 1);//2
	particles.Add("C3p", 3, MyMass::Carbon12(), 0, 1);//3
	particles.Add("C2p", 2, MyMass::Carbon12(), 0, 1);//2
	particles.Add("C1p", 1, MyMass::Carbon12(), 0, 1);//3
	...
	particles.Add("I9p", 9, MyMass::Iodine127(), 0, 100);//8
	particles.Add("I8p", 8, MyMass::Iodine127(), 0, 100);//9
	particles.Add("I7p", 7, MyMass::Iodine127(), 1, 100);//10
	particles.Add("I6p", 6, MyMass::Iodine127(), 1, 100);//11
	particles.Add("I5p", 5, MyMass::Iodine127(), 1, 100);//14
	particles.Add("I4p", 4, MyMass::Iodine127(), 1, 100);//13
	particles.Add("I3p", 3, MyMass::Iodine127(), 1, 100);//14
...
void AddCH2I2_CII34(MyParticleContainer &particles)
{
	...
	particles.Add("C4p", 4, MyMass::Carbon12(), 12, 1);//2
	particles.Add("C3p", 3, MyMass::Carbon12(), 1, 1);//3
	particles.Add("C2p", 2, MyMass::Carbon12(), 1, 1);//2
	particles.Add("C1p", 1, MyMass::Carbon12(), 1, 1);//3
	...
	//particles.Add("I14p",14,MyMass::Iodine127(),1,0);
	//particles.Add("I13p",13,MyMass::Iodine127(),1,0);
	particles.Add("I12p",12,MyMass::Iodine127(),1,2);
	particles.Add("I11p",11,MyMass::Iodine127(),1,2);
	particles.Add("I10p",10,MyMass::Iodine127(),1,2);//7
	particles.Add("I9p", 9, MyMass::Iodine127(), 13, 2);//8
	particles.Add("I8p", 8, MyMass::Iodine127(), 13, 2);//9
	particles.Add("I7p", 7, MyMass::Iodine127(), 13, 2);//10
	particles.Add("I6p", 6, MyMass::Iodine127(), 13, 2);//11
	particles.Add("I5p", 5, MyMass::Iodine127(), 13, 0);//14
	particles.Add("I4p", 4, MyMass::Iodine127(), 13, 0);//13
	particles.Add("I3p", 3, MyMass::Iodine127(), 13, 0);//14
	particles.Add("I2p", 2, MyMass::Iodine127(), 13, 0);//15
	particles.Add("I1p", 1, MyMass::Iodine127(), 13, 0);//16
...
void AddCH2I2_CII(MyParticleContainer &particles)
{
	...
	particles.Add("C4p", 4, MyMass::Carbon12(), 1, 1);//2
	particles.Add("C3p", 3, MyMass::Carbon12(), 1, 1);//3
	particles.Add("C2p", 2, MyMass::Carbon12(), 12, 1);//2
	particles.Add("C1p", 1, MyMass::Carbon12(), 12, 1);//3
	...
	particles.Add("I12p",12,MyMass::Iodine127(),1,0);
	particles.Add("I11p",11,MyMass::Iodine127(),1,0);
	particles.Add("I10p",10,MyMass::Iodine127(),13,2);//7
	particles.Add("I9p", 9, MyMass::Iodine127(), 13, 2);//8
	particles.Add("I8p", 8, MyMass::Iodine127(), 13, 2);//9
	particles.Add("I7p", 7, MyMass::Iodine127(), 13, 2);//10
	particles.Add("I6p", 6, MyMass::Iodine127(), 13, 2);//11
	particles.Add("I5p", 5, MyMass::Iodine127(), 13, 2);//14
	particles.Add("I4p", 4, MyMass::Iodine127(), 13, 2);//13
	particles.Add("I3p", 3, MyMass::Iodine127(), 13, 2);//14
	particles.Add("I2p", 2, MyMass::Iodine127(), 13, 2);//15
	particles.Add("I1p", 1, MyMass::Iodine127(), 13, 2);//16
