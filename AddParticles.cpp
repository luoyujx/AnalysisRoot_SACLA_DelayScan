...
void AddCH2I2(MyParticleContainer &particles)
{
	...
	particles.Add("CHHII1p", 1, MyMass::Carbon12() + MyMass::Hydrogen1() * 2 + MyMass::Iodine127() * 2, 1, 0);//16
	particles.Add("CHHI1p", 1, MyMass::Carbon12() + MyMass::Hydrogen1() * 2 + MyMass::Iodine127(), 1, 0);//16
	particles.Add("CHH1p", 1, MyMass::Carbon12() + MyMass::Hydrogen1()*2, 1, 0);//16
	particles.Add("CH1p", 1, MyMass::Carbon12() + MyMass::Hydrogen1(), 1, 0);//16
}
