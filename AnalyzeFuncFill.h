...
void fillParticleHistograms(const MyParticle &p, const MyParticleHit &ph, std::vector<double>& intensity, std::vector<double>& delay, MyHistos &hi, int hiOff, std::vector<double>& intPart, int, double, double, double limitOfThetaZ);
